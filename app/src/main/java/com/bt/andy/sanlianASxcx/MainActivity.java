...
import com.bt.andy.sanlianASxcx.fragment.Home_F;
import com.bt.andy.sanlianASxcx.fragment.Search_F;
import com.bt.andy.sanlianASxcx.fragment.User_F;
...
public class MainActivity extends BaseActivity implements View.OnClickListener {
    ...
    // 界面底部的选中菜单按钮资源
    private int[]       select_on  = {R.drawable.home_on, R.drawable.search_on, R.drawable.me_on};
    // 界面底部的菜单按钮id
