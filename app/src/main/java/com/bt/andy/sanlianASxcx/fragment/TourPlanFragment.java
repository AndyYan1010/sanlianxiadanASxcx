...
public class TourPlanFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        mRootView = LayoutInflater.from(getActivity()).inflate(R.layout.fragment_tour_plan, null);
        initView();
        initData();
        return mRootView;
    }
    ...
    private void initData() {
        ...
        mData.add("4");
        mData.add("5");
        LvAcceptAdapter tourPlanAdapter = new LvAcceptAdapter(getContext(), mData);
